	...
	<div id="main">
		<div class="register_content">
			...
			<div class="register_message">
				<form action="RegisterServ" method="post" id="myform"
					onSubmit="return checkRegister()">

					<dl class="register_row">
						<dt>用户名：</dt>
						<dd>
							<input id="nickName" name="user_name" type="text" class="register_input"
					...
					<dl class="register_row">
						<dt>密码：</dt>
						<dd>
							<input id="pwd" name="user_pass" type="password" class="register_input"
					...
					<dl class="register_row">
						<dt>电话：</dt>
						<dd>
							<input id="repwd" name="user_tel" type="password" class="register_input"
					...
					<dl class="register_row">
						<dt>地址：</dt>
						<dd>
							<input id="email" name="user_address" type="text" class="register_input"
					...
					<dl class="register_row">
						<dt>性别：</dt>
						<dd>
							<input name="sex" id="man" type="radio" value="男"> <label
								for="man">男</label>
						</dd>
						<dd>
					...
					<div class="registerBtn">
						<input id="registerBtn" type="image"
							src="images/register_btn_out.gif" onMouseOver="btn_over()"
							onMouseOut="btn_out()">
					</div>
				</form>
			</div>
