		...
		<form name=alipayment action=alipay.trade.page.pay.jsp method=post
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDout_trade_no" name="WIDout_trade_no" value="${orders_id }" />
					</dd>
					<hr class="one_line">
					<dt>订单名称 ：</dt>
					<dd>
		...
		<form name=tradequery action=alipay.trade.query.jsp method=post
			...
			<div id="body2" class="tab-content" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDTQout_trade_no" name="WIDTQout_trade_no" value="${orders_id }" />
					</dd>
					<hr class="one_line">
					<dt>支付宝交易号 ：</dt>
					<dd>
		...
		<form name=tradeclose action=alipay.trade.close.jsp method=post
			...
			<div id="body5" class="tab-content" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDTCout_trade_no" name="WIDTCout_trade_no" value="${orders_id }"/>
					</dd>
					<hr class="one_line">
					<dt>支付宝交易号 ：</dt>
					<dd>
