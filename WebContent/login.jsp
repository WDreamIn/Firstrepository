...
<body>
<div id="header">
   <div class="login_header_left"><img src="img/logo.jpg" alt="logo"></div>
...
<div id="main">
  ...
  <div class="login_main_mid">
    ...
    <form action="LoginServ" method="post" onSubmit="return checkLogin()">
    <dl class="login_content">
       <dt>用户名：</dt>
       <dd><input name ="user_name" id="email" type="text" class="login_content_input" onFocus="emailFocus()" onBlur="emailBlur()"></dd>
    </dl>
     <dl class="login_content">
       <dt>密码：</dt>
       <dd><input name = "user_pass" id="pwd" type="password" class="login_content_input" onFocus="pwdFocus()" onBlur="pwdBlur()"></dd>
    </dl>
     <dl class="login_content">
       <dt></dt>
