...
<body>
	...
	<div id="main">
		...
		<div class="shopping_commend">
			...
			<div class="shopping_commend_right">
				<img src="images/shopping_arrow_up.gif" alt="shopping"
					id="shopping_commend_arrow" onClick="shopping_commend_show()">
			</div>
		</div>
		...
		<form action="OrdersServ" method="post">
			<div class="shopping_list_border">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					id="myTableProduct">
					<c:forEach items="${list}" var="objmap">

						<tr class="shopping_product_list" id="shoppingProduct_01"
							onMouseOver="productOver('shoppingProduct_01')"
							onMouseOut="productOut('shoppingProduct_01')">
							<td class="shopping_product_list_1"><input type="checkbox"
								name="details_goods" id="" value="${objmap.shopping_goods}" checked="checked" /> <a
								href="GoodsMessageServ?goods_id=${objmap.shopping_goods}"
								class="blue"> ${objmap.goods_name}</a><img alt=""
								src="${objmap.goods_img}" width="100px" height="100px"></td>
							<td class="shopping_product_list_2"><label>189</label></td>
							<td class="shopping_product_list_3">￥<label>
									${objmap.shopping_price}</label></td>
							<td class="shopping_product_list_4">￥<label>${objmap.shopping_price}</label>(59折)
							<input name="details_price${objmap.shopping_goods}" value="${objmap.shopping_price}">
							</td>
							<td class="shopping_product_list_5"><input name="details_num${objmap.shopping_goods}" type="text"
								value="${objmap.shopping_num}" onblur="productCount()"></td>
							<td class="shopping_product_list_6"><a
								href="javascript:deleteProduct('shoppingProduct_01')"
								class="blue">删除</a></td>
						</tr>
				...
				<div class="ordersmessage" style="margin-top: 10px;">
					<ul class="floatclear">
						...
						<li class="ordersmessageli"><input type="text" id="" value=""
							name="orders_address" /></li>
